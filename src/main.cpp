...
int main()
{
    // Crear objetos
    // Objeto ventana
    sf::RenderWindow window(sf::VideoMode(500, 600), "Frgger");
    ...
    while (window.isOpen())
    {
        ...
        // Si ha pasado más de 2 sedundos , qeuda 1 segundo
        ...
        // Si ha pasado un segundo o más, genera un vehículo o tronco en cada carril
